...
const names=["Dr Shree","Dr Ajay","Dr Vijay","Dr Verma","Dr Kirti","Dr Sharma","Dr Shivam","Dr Shivani","Dr Shivangi","Dr Shivansh","Dr Ayush"]
const getRandomPart = () => {
...
const ScheduleMeeting = () => {
  ...
  return (
    ...
    <div className={classes["schedule-meeting-container"]}>
      <Typography variant="h4" gutterBottom color={"#052f58"} fontWeight={"600"} margin={"1rem"}>
        Schedule a Meeting
      </Typography>
      <TextField
      ...
      {scheduledMeeting && (
        <div className={classes["scheduled-meeting-info"]}>
          ...
          <Typography>Name: {names[Math.floor(Math.random() * names.length)]}</Typography>
          <Typography>Description of Problem:{scheduledMeeting.name}</Typography>
          <Typography>Time: {scheduledMeeting.time}</Typography>
          <Typography>Link:<a href={scheduledMeeting.link} target="_blank" rel="noopener noreferrer">
