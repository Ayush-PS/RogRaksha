...
function Home() {
  ...
  return (
    <>
    <motion.div className={classes.home} initial="hidden"
    animate="visible"
    ...
    transition={{ duration: 1, ease: 'easeInOut' }}>
      <div className={classes.th}>
        ...
        <p>
          ...
          landscape and stay ahead of the competition.With a focus on innovation
          and client satisfaction, we strive to deliver exceptional solutions.
        </p>
